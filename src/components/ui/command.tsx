...
function CommandInput({
  ...
  return (
    <div
      ...
      className="flex h-9 items-center gap-2 rounded-lg border border-input/30 bg-input/30 px-2.5"
    >
...
function CommandItem({
  ...
  return (
    ...
    >
      {children}
      {/* ms-auto = inline-start:auto to end-align this decorative check within the
          item's flex row (internal layout, not the primitive's external margin — ADR 0058). */}
