...
export const panelIntent = {
  meta: {
    ...
    usedIn: [
      ...
      "src/widgets/overview-dashboard/ui/FunnelPreview.tsx",
      ...
      "src/widgets/overview-dashboard/ui/SegmentScatter.tsx",
      "src/widgets/overview-dashboard/ui/StackedBars.tsx",
