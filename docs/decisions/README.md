...
| [0081](0081-mission-control-design-token-vocabulary.md) | Mission-control design-token vocabulary on a re-introduced primitive layer | proposed | 2026-06-22 |
| [0082](0082-multitenant-density-runtime-theming.md) | Multi-tenant and density runtime theming via data-attributes, on a swap-only primitive layer | proposed | 2026-06-22 |
